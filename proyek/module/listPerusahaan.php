...
<body>
    <div id="home" class="container-fluid">
        ...
        <div class="row pt-5 mt-5">
            ...
            <div class="card ml-5 border border-info" style="width: 18rem; height: 34rem;">
            ...
            <div class="card ml-5 border border-info" style="width: 18rem; height: 34rem;">
                <img src="../img/xl.gif" class="card-img-top" style="width: 100%; height: 30%;">
                <div class="card-body mt-5">
                    <h3 class="card-title" style="color:black">XL Axiata Tbk PT</h3>
                    <h5 style="color:black">Phone : <br> 0215761881</h5>
                    <h5 style="color:black">Address : <br> Jl. DR. Ide Anak Agung Gde Agung Lot E4 – 7 No.1, Mega Kuningan, Jakarta 12950</h5>
                </div>
                <div class="button mb-3 ml-3">
                    <a href="https://careers.google.com" class="btn btn-primary">Tinjau Perusahaan</a>
                </div>
            ...
            <div class="card ml-5 border border-info" style="width: 18rem; height: 34rem;">
                <img src="../img/nokia.gif" class="card-img-top" style="width: 100%; height: 30%;">
                <div class="card-body mt-5">
                    <h3 class="card-title" style="color:black">Nokia Solution and Networks PT</h3>
                    <h5 style="color:black">Phone : <br> 0215761881</h5>
                    <h5 style="color:black">Address : <br> Jl. Petamburan E4 – 7 No.1, Mega Kuningan, Jakarta</h5>
                </div>
                <div class="button mb-3 ml-3">
                    <a href="https://www.nokia.com/networks/" class="btn btn-primary">Tinjau Perusahaan</a>
                </div>
            </div>
